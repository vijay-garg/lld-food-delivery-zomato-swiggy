...
public class FoodMenuController {
  ...
  public void addMenuByRestaurantId(
      final String menuId, final String restaurantId, final List<MenuItem> menuItemList) {
  ...
  public void addMenuItemsByRestaurantId(
      final String restaurantId, final List<MenuItem> menuItemList) {
  ...
  public List<MenuItem> getMenuItemsByRestaurantIdAndCuisine(
      final String restaurantId, final CuisineType cuisineType) {
  ...
  public List<MenuItem> getMenuItemsByRestaurantIdAndMealType(
      final String restaurantId, final MealType mealType) {
